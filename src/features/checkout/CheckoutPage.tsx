      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_360px]">
          ...
          <section className="rounded-md bg-white p-4 shadow-card sm:p-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                />
                {errors.fullName && <p className="mt-1 text-xs text-flash-dark">{errors.fullName}</p>}
              </div>

              <div className="sm:col-span-2">
                <label className={label} htmlFor="email">
                  Email {method === 'pay_on_delivery' && <span className="font-normal normal-case">(optional)</span>}
                </label>
                <input
                  id="email" type="email" className={field} value={address.email}
              ...
              <div>
                ...
                />
                {errors.phone && <p className="mt-1 text-xs text-flash-dark">{errors.phone}</p>}
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                />
                {errors.street && <p className="mt-1 text-xs text-flash-dark">{errors.street}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ikeja"
                />
                {errors.city && <p className="mt-1 text-xs text-flash-dark">{errors.city}</p>}
              </div>
        ...
        <div className="space-y-3 lg:sticky lg:top-44 lg:self-start">
          <div className="rounded-md bg-white p-4 shadow-card">
            ...
            {submitError && (
              <p role="alert" className="mt-3 rounded-md bg-flash/10 px-3 py-2 text-xs font-semibold text-flash-dark">
                {submitError}
              </p>
            )}
